...
public class Assert {
	...
	public static void notEmpty(@Nullable Object[] arr) {
		notEmpty(arr, null);
	}
	...
	public static void notNull(@Nullable Object o, String errorMsg) {
		if (o == null) {
			if (errorMsg != null) {
	 ...
	 */
	public static void notBlank(@Nullable String content, String errorMsg) {
	...
	public static void notEmpty(@Nullable Collection c, String errorMsg) {
	...
	public static void notEmpty(@Nullable Object[] arr, String errorMsg) {
