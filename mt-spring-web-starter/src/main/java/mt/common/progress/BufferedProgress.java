...
public class BufferedProgress implements Progress {
	...
	public static void main(String[] args) {
		...
		Progress progress = new ProgressListener(localProgress) {
			@Override
			public void listen(@NotNull String key, double percent) {
				System.out.println(percent);
				count.incrementAndGet();
			}
		};
		BufferedProgress bufferedProgress = new BufferedProgress(progress, 0.5);
		String key = "test";
		...
		System.out.println("result:" + progress.getPercent(key));
	}
}
