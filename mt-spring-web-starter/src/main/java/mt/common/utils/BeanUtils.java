...
public class BeanUtils {
	...
	public static <T> List<T> batchTransform(List<?> srcList, Class<T> clazz) {
		return batchTransform(clazz, srcList);
	}
	 ...
	 * </pre>
	 */
	public static <T> List<T> batchTransform(Class<T> clazz, List<?> srcList) {
