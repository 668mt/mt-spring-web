...
@Component
public class CreatedDateInterceptor extends BaseInterceptor {
	@Override
	public Object intercept(Invocation invocation) throws Throwable {
		...
		setFieldsValue(parameters, CreatedDate.class, false, new InterceptorHelper.AbstractValueGenerator<Date>() {
			@Override
